...
class OtoDomParserOld(Parser):
    ...
    def find_flats(self):
        ...
        # find_flats = sum([find_flats, find_image],[])
    ...
    def find_image(self):
        ...
        for image in find_image:
            # image_list.append(image.find('span', {'class':'img-cover lazy'}))
...
class Flat(Parser):
    ...
    def link(self):
        ...
        # single_flat = requests.get(single_link)
        # single_flat = single_flat.content
        # market_soup = BeautifulSoup.BeautifulSoup(single_flat)
        # market = market_soup.find('section',{'class':'overview'})
        # print(market)
    ...
    def renting_or_selling(self): #wyrazenie regularne, jak zlapac wzorzec
        ...
        # return flat_renting_or_selling.encode('utf=
    ...
    def numbers_of_rooms(self):
        # rooms = self.flat.find('li').getText()
...
# # #
# # # oto_dom_page = requests.get('https://www.otodom.pl/wynajem/mieszkanie/wroclaw/')
# oto_dom_page_selling = requests.get('https://www.otodom.pl/sprzedaz/mieszkanie/wroclaw')
# # print(oto_dom_page)
# flat = OtoDomParserOld(oto_dom_page_selling.content)
# # flat = OtoDomParser(oto_dom_page.content)
# # print(flat)
# flat.collect_flats_info()
# flats = flat.get_flats_info()
# print(flats)
